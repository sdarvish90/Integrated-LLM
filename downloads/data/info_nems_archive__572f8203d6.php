...
<head>
	<title>Availability of the National Energy Modeling System (NEMS) Archive</title>
...
<title>U.S. Energy Information Administration (EIA) - Source</title>
    </head>
...
<div class="pub_title bg_aeo">
    <a href="/outlooks/">&lsaquo; Analysis &amp; Projections</a>
  <h1>Annual Energy Outlook 2025</h1>
  <p><strong>Release date:</strong> April 15, 2025 &nbsp; | &nbsp;<strong>Next release date:</strong>&nbsp; TBD
    &nbsp;
      </p>
</div>
<div class="subnav">
  <ul>
    <li ><a href="/outlooks/aeo/">Overview</a>
    </li>
    <li class="dropdown "><a>Data</a></li>
    <div class="dat_block">
      <ul>
        <li><a href="/outlooks/aeo/tables_ref.php">Reference Case</a></li>
        <li><a href="/outlooks/aeo/tables_side_xls.php">Side Cases</a></li>
        <li><a href="/outlooks/aeo/data/browser/">Interactive Table Viewer</a></li>
      </ul>
    </div>
            <!-- 
        <li ><a href="additional_docs.php">Additional AEO Documentation</a></li>
         -->
</div>
<!-- /*li class="dropdown active"><a>Topics</a></li>
        <div class="dat_block">
          <ul class="split_3columns">
          	<li style="border-bottom:1px solid #cccccc;" onmouseover="this.style.cursor='default'">Source</li>
            <li><a href="source_oil.cfm">Oil/Liquids</a></li>
            <li><a href="source_natural_gas.cfm">Natural Gas</a></li>
            <li><a href="source_coal.cfm">Coal</a></li>
            <li><a href="sector_electric_power.cfm">Electricity</a></li>
            <li><a href="source_renewable.cfm">Renewable/Alternative</a></li>
            <li><a href="source_nuclear.cfm">Nuclear</a></li>
            <li style="border-bottom:1px solid #cccccc;" onmouseover="this.style.cursor='default'">Sector</li>
            <li><a href="sector_residential.cfm">Residential</a></li>
            <li><a href="sector_commercial.cfm">Commercial</a></li>
            <li><a href="sector_industrial.cfm">Industrial</a></li>
            <li><a href="sector_transportation.cfm">Transportation</a></li>
            <li><a href="sector_energydemand.cfm">Energy Demand</a></li>
            <li>&nbsp;&nbsp;</li>
            <li style="border-bottom:1px solid #cccccc;" onmouseover="this.style.cursor='default'">Other</li>
            <li><a href="topic_emissions.cfm">Emissions</a></li>
            <li><a href="topic_prices.cfm">Prices</a></li>
            <li><a href="topic_macroeconomic.cfm">Macroeconomic</a></li>
            <li><a href="topic_international.cfm">International</a></li>
            <li><a href="topic_efficiency.cfm">Efficiency</a></li>
            <li>&nbsp;&nbsp;</li>
           </ul>
        </div*/ ?>
        -->
...
<div class="pagecontent mr_temp4">
  ...
  <div class="main_col">
    <h2><strong>Download the National Energy Modeling System (NEMS)</strong></h2>
    <h2>Overview</h2>
    <p>NEMS is an integrated model of the U.S. energy system. For an overview of NEMS, see <em><a href="/outlooks/aeo/nems/overview/pdf/0581(2023).pdf" class="ico pdf">The National Energy Modeling System: An Overview 2023</a></em>. More detailed <a href="/outlooks/aeo/nems/documentation/">documentation</a> of NEMS is also available.</p>
  <p>The open-source NEMS code allows the public to replicate the <em>Annual Energy Outlook 2025</em> (AEO2025) results and discloses the source code and inputs used.  </p>
  <p>NEMS is available on <a href="https://github.com/EIAgov/NEMS">GitHub</a>  </p>
  </div>
    <div class="aeo_footer blue_top">
	<div class="aeo_inner">
		<span class="left_box">
			<h4>About the Annual Energy Outlook</h4>
			<ul class="no-liststyle">
				<li><a href="/about/contact/forecasting.php">Contact information and staff</a></li>
				<li><a href="/outlooks/aeo/info_nems_archive.php">Download NEMS</a></li>
				<li><a href="/outlooks/aeo/retrospective/">Retrospective Review</a></li>
				<li><a href="/outlooks/aeo/nems/overview/pdf/0581(2023).pdf" class="ico_pdf2">NEMS: An Overview
					(2023)</a></li>
			</ul>
		</span>
		<span class="mid_box">
			<h4>Previous Editions of the AEO</h4>
			<form name="form" id="form">
				<select name="jumpMenu" id="jumpMenu" style="width:110px">
					<option value="/outlooks/archive/aeo23/">2023</option>
					<option value="/outlooks/archive/aeo22/">2022</option>
					<option value="/outlooks/archive/aeo21/">2021</option>
					<option value="/outlooks/archive/aeo20/">2020</option>
					<option value="/outlooks/archive/aeo19/">2019</option>
					<option value="/outlooks/archive/aeo18/">2018</option>
					<option value="/outlooks/archive/aeo17/">2017</option>
					<option value="/outlooks/archive/aeo16/">2016</option>
					<option value="/outlooks/archive/aeo15/">2015</option>
					<option value="/outlooks/archive/aeo14/">2014</option>
					<option value="/outlooks/archive/aeo13/">2013</option>
					<option value="/outlooks/archive/aeo12/">2012</option>
					<option value="/outlooks/archive/aeo11/">2011</option>
					<option value="/outlooks/archive/aeo10/index.html">2010</option>
					<option value="/outlooks/archive/aeo09/index.html">2009</option>
					<option value="/outlooks/archive/aeo08/index.html">2008</option>
					<option value="/outlooks/archive/aeo07/index.html">2007</option>
					<option value="/outlooks/archive/aeo06/index.html">2006</option>
					<option value="/outlooks/aeo/archive.cfm">See all</option>
				</select>
				<input type="button" name="go_button" class="arrow_go" align="absmiddle" id="go_button" value="Go"
					onclick="MM_jumpMenuGo('jumpMenu','parent',1)" />
			</form>
		</span>

		<span class="right_box">
			<h4>Documentation and Assumptions</h4>
			<ul>
								<li><a href="/outlooks/aeo/assumptions/case_descriptions.php"><em>Annual Energy Outlook 2025</em> Case
						Descriptions</a></li>
				<li><a href="/outlooks/aeo/assumptions/">Assumptions report</a></li>
				<li><a href="/outlooks/aeo/workinggroup/">Working Groups</a></li>
				<li><a href="/outlooks/aeo/nems/documentation/">Model documentation</a></li>
				<li><a href="/outlooks/aeo/additional_docs.php">Additional AEO Documentation</a></li>
				<li><a href="/outlooks/aeo/resources/">AEO2025 Model Development</a></li>
			</ul>
