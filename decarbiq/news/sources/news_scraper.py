"""
News Scraper Adapter — wraps ``BlueH2NewsCollector.collect_scrapers()``.
"""
...
class NewsScraperAdapter(SourceAdapter):
    """Adapter for web scraper collection (H2 Insight, DecarbonFuse, etc.).

    Delegates to ``BlueH2NewsCollector.collect_scrapers()``.
    """

    priority = 70   # lower priority — slower, less reliable
